...
-- CreateIndex
CREATE INDEX "Message_userMessagesId_idx" ON "Message"("userMessagesId");

-- AddForeignKey
ALTER TABLE "Message" ADD CONSTRAINT "Message_userMessagesId_fkey" FOREIGN KEY ("userMessagesId") REFERENCES "UserMessages"("id") ON DELETE CASCADE ON UPDATE CASCADE;
